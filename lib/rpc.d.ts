...
export declare function registerNvimNotification(method: string, label: string, fn: NvimNotificationHandler): void;
...
export declare function dispatchNvimNotification(app: App, method: string, args: unknown[]): Promise<void>;
