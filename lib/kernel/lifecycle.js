        ...
        try {
            ...
            if (app.slices.runtime.restartPending) {
                ...
                try {
                    ...
                    const next = spawn('/bin/sh', ['-c', 'sleep 2; exec python3 -c "import os,sys; os.setsid(); os.execv(sys.argv[1], sys.argv[1:])" "$@"',
                        'sh', process.argv[0], ...process.argv.slice(1)], { stdio: 'inherit' });
