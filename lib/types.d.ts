...
export interface GoalsService {
    ...
    create: (agent: unknown, opts: {
        objective: string;
    }) => void;
    pause: (agent: unknown, ref?: {
        id: string;
        revision: number;
    }) => void;
    resume: (agent: unknown, ref?: {
        id: string;
        revision: number;
    }) => void;
...
export interface FileReferencesService {
    list?: (agent: unknown, query: string, signal: AbortSignal) => Promise<Array<{
        path: string;
    }>>;
}
...
export interface AgentPresetsService {
    ...
    recompose?: (agentCtx: unknown, presetId: string) => Promise<{
        id: string;
    }>;
}
