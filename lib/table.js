 ...
 * @returns {Array<{text: string, group: string|null, spans: []}>}
 */
export function renderTable(block, closed) {
 ...
 * @returns {Array<{table: true, text: string, group: string|null, spans: []} | {table: false, raw: string}>}
 */
