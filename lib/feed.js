...
export class FeedRenderer {
    ...
    ticker;
    eventTime;
    constructor(nvim, bufId, winId, { flushDelayMs = 40, idsProvider = null, activeChecker = null, reasoningBuf = null, reasoningView = null, inlineReasoning = false, whale = false, } = {}) {
        this.nvim = nvim;
        this.bufId = bufId;
        this.winId = winId;
