...
export const createSession = async (app: App, cwdPath?: string) => {
...
export const resumeSession = async (app: App, id: string) => {
...
export const selectSession = async (app: App, id: string) => {
...
export const forkSession = async (app: App, directive: string | undefined): Promise<string | undefined> => {
...
export const welcomeLines = (): { above: Array<{ text: string; group?: string }>; below: Array<{ text: string; group?: string }> } => {
...
export const updateTitle = (app: App) => {
