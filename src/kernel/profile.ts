...
/** Loader entry shape (duck-typed against cordis-plugin-loader). */
interface LoaderEntryLike {
  id?: string
  options?: { name?: string; config?: { path?: unknown } }
}

export function runningProfileName(app: App): string | undefined {
